# Graph Report - g-helper-linux  (2026-08-05)

## Corpus Check
- 70 files · ~139,148 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1539 nodes · 3744 edges · 71 communities (67 shown, 4 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 11 edges (avg confidence: 0.64)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b13aee85`
...
- `print_fan_caps()` --references--> `FanCaps`  [EXTRACTED]
  crates/rog-cli/src/main.rs → crates/rog-core/src/model.rs
- `print_fan_info()` --references--> `FanInfo`  [EXTRACTED]
  crates/rog-cli/src/main.rs → crates/rog-core/src/model.rs
...
Cohesion: 0.07
Nodes (59): FanCaps, GpuMode, LightingState, apply_fan_caps_to_device_caps(), battery_state_to_str(), caps_to_dbus(), caps_to_dbus_emits_feature_access_status_and_reason_keys(), ControlState (+51 more)
...
Cohesion: 0.09
Nodes (44): Application, AsRef, Box, FeatureAvailability, build_fan_card_slot(), build_fan_visual_slot(), build_fans_gauge_card(), build_ui() (+36 more)

### Community 8 - "String"
Cohesion: 0.09
Nodes (48): AppState, CpuCaps, CpuCoreTelemetry, CpuTelemetry, DeviceCaps, FanState, Vec, TelemetrySnapshot (+40 more)
...
Cohesion: 0.07
Nodes (38): Button, ComboBoxText, apply_update_action(), can_stage_update_in_dir(), compare_versions(), cpu_toggle_dialog_title(), Daemon1, detect_update_capability() (+30 more)

### Community 11 - "fan_widgets.rs"
Cohesion: 0.12
Nodes (29): Color, Context, CurvePreview, CurvePreviewState, draw_blade(), draw_center_text(), draw_curve_preview(), draw_fan_rotor() (+21 more)
...
### Community 14 - ".new"
Cohesion: 0.11
Nodes (34): Client, apply_battery_limit(), apply_cpu_actions(), apply_fan_action(), apply_gpu_mode(), apply_lighting(), apply_profile(), AppMetadata (+26 more)
...
Cohesion: 0.13
Nodes (19): AppSettings, AppSettingsFile, autostart_desktop_entry(), autostart_enabled(), autostart_entry_supports_minimized_launch(), autostart_file_path(), CloseBehavior, install_css() (+11 more)

### Community 20 - "model.rs"
Cohesion: 0.13
...
Cohesion: 0.13
Nodes (15): ActionRow, append_detail_row(), build_detail_rows(), DetailRow, gpu_mode_to_dropdown_index(), pref_value_row(), push_history(), RogTray (+7 more)

### Community 23 - "OwnedValue"
Cohesion: 0.19
Nodes (21): caps_from_dbus(), caps_from_dbus_parses_feature_access_status_and_reason_keys(), caps_text_from_dbus(), cpu_caps_from_dbus(), cpu_caps_from_dbus_parses_structured_control_access_rows(), cpu_control_access_from_dbus(), cpu_path_access_from_dbus(), cpu_telemetry_from_dbus() (+13 more)
...
Cohesion: 0.10
Nodes (20): About, Battery, CPU, Current Capability Behavior, Current Pages, Current Update Model, Current Window Structure, Dashboard (+12 more)
...
Cohesion: 0.16
Nodes (6): CpuAccessState, CpuControlAccess, CpuControlKind, display_backend_name(), FanControlMode, normalize_lighting_word()
...
### Community 33 - "String"
Cohesion: 0.16
Nodes (11): CpuPathAccess, LightingDiagnostics, list_text(), opt_text(), opt_u32(), Option, String, build_lighting_diagnostics() (+3 more)
...
- **Why does `TopProcessMem` connect `memory.rs` to `rog-daemon/src/main.rs`, `String`, `String`, `.new`, `model.rs`?**
...
- **Why does `BatteryState` connect `power_supply.rs` to `String`, `rog-daemon/src/main.rs`, `model.rs`?**
