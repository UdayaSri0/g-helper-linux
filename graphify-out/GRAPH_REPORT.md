...
## Corpus Check
- 76 files · ~153,695 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1745 nodes · 4297 edges · 89 communities (84 shown, 5 thin omitted)
...
Cohesion: 0.06
Nodes (63): BatteryLimitPercent, apply_fan_caps_to_device_caps(), battery_state_to_str(), caps_to_dbus(), caps_to_dbus_emits_feature_access_status_and_reason_keys(), ControlState, cpu_access_warning(), cpu_caps_to_dbus() (+55 more)
...
Cohesion: 0.08
Nodes (35): autostart_desktop_entry(), autostart_enabled(), autostart_entry_supports_minimized_launch(), autostart_file_path(), can_stage_update_in_dir(), cpu_toggle_dialog_title(), Daemon1, dashboard_mode_columns() (+27 more)
...
Cohesion: 0.09
Nodes (24): GithubReleaseResponse, gpu_mode_to_dropdown_index(), initial_update_state(), open_uri_with_feedback(), OpenLinkRequest, PendingCpuAction, PendingFanAction, PendingLighting (+16 more)
...
Cohesion: 0.16
Nodes (6): FanCaps, PermissionKind, PermissionState, PermissionStatus, SetupStatus, fan_permission_status()
...
## Knowledge Gaps
- **413 isolated node(s):** `LightingProvider`, `TelemetryProvider`, `Daemon1`, `rog-helper-apprun-hook.sh script`, `PATH` (+408 more)
...
- **Why does `CpuCaps` connect `String` to `rog-daemon/src/main.rs`, `cpu.rs`, `String`, `OwnedValue`, `setup.rs`, `model.rs`, `SharedUiState`, `CpuControlAccess`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `FanInfo` connect `FanInfo` to `rog-daemon/src/main.rs`, `hwmon.rs`, `rog-cli/src/main.rs`, `String`, `String`, `OwnedValue`, `Self`, `.sanitize`, `model.rs`?**
