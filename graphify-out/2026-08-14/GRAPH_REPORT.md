# Graph Report - g-helper-linux  (2026-08-14)

## Corpus Check
- 87 files · ~182,415 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2156 nodes · 5495 edges · 103 communities (99 shown, 4 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 55 edges (avg confidence: 0.77)
...
### Community 0 - "String"
Cohesion: 0.18
Nodes (30): AppState, caps_to_dbus(), caps_with_control_matrix_to_dbus(), control_privilege_matrix(), control_privilege_row_to_dbus(), cpu_caps_to_dbus(), cpu_control_access_to_dbus(), cpu_path_access_to_dbus() (+22 more)
...
Cohesion: 0.07
Nodes (64): FanCaps, FanControlRequest, FanCurve, FanDomain, FanPoint, FanTelemetry, asus_channel_paths(), AsusCurveChannel (+56 more)
...
Cohesion: 0.08
Nodes (58): backend_access_from_connect_error(), backend_connect_status_maps_error_to_temporarily_unavailable(), backend_connect_status_maps_missing_backend_without_error(), Cli, Cmd, cmd_caps(), cmd_dbus(), cmd_fan_caps() (+50 more)

### Community 5 - "cpu.rs"
Cohesion: 0.07
Nodes (68): cpu_request_readback_matches(), CpuControlRequest, CpuFrequencyBounds, CpuPowerMode, frequency_bounds_and_inversion_are_rejected(), normalize_cpu_token(), Option, RogResult (+60 more)
...
Cohesion: 0.06
Nodes (46): Cell, autostart_desktop_entry(), autostart_enabled(), autostart_entry_supports_minimized_launch(), autostart_file_path(), can_stage_update_in_dir(), compare_versions(), Daemon1 (+38 more)

### Community 8 - "spawn_background"
Cohesion: 0.10
Nodes (31): Client, apply_battery_limit(), apply_cpu_actions(), apply_gpu_mode(), apply_profile(), apply_update_action(), AppMetadata, build_github_client() (+23 more)
...
Cohesion: 0.14
Nodes (28): ambiguous_multi_battery_writes_are_rejected(), battery_dirs(), BatteryChargeLimitControl, charge_limit_bounds_are_shared_with_asusd(), charge_limit_rejects_an_attribute_symlink_escape(), charge_limit_uses_only_an_exact_battery_device(), Fixture, parse_battery_state() (+20 more)

### Community 13 - "supergfx.rs"
Cohesion: 0.11
Nodes (30): GpuMode, apply_gpu_switch_status_to_caps(), pending_gpu_transition_is_unavailable_until_logout_or_reboot(), action_name_from_u32(), allows_text_mode_fallback(), classify_dbus_error(), map_dbus_error(), mode_id_from_text() (+22 more)
...
### Community 20 - "Self"
Cohesion: 0.14
Nodes (4): BatteryLimitPercent, FeatureAccessState, Into, Self
...
Cohesion: 0.06
Nodes (65): ActionRow, Application, Button, ComboBoxText, AccessUiState, AdministratorAccessRows, append_detail_row(), build_detail_rows() (+57 more)

### Community 23 - ".as_str"
Cohesion: 0.09
Nodes (6): CpuAccessState, CpuAuthorization, CpuControlKind, FanControlMode, FanMappingConfidence, GpuSwitchState
...
Cohesion: 0.10
Nodes (11): empty_fan_curve_is_rejected(), lighting_diagnostics_explains_asusd_without_aura(), lighting_diagnostics_explains_potential_unimplemented_aura_interface(), lighting_diagnostics_formats_read_only_sysfs_warning(), lighting_diagnostics_formats_sysfs_only_brightness_report(), out_of_range_percent_request_is_rejected(), rpm_target_rejected_when_unsupported(), BTreeMap (+3 more)
...
### Community 30 - "Option"
Cohesion: 0.08
Nodes (51): CpuCaps, DeviceCaps, FeatureAvailability, PrivilegedStatus, Option, canonicalize_git_remote_url(), combined_asusd_issue(), cpu_banner_title() (+43 more)
...
Cohesion: 0.18
Nodes (5): DependencyKind, PermissionKind, PermissionStatus, SetupStatus, fan_permission_status()
...
### Community 49 - ".new"
Cohesion: 0.10
Nodes (27): Adjustment, apply_fan_action(), apply_lighting(), caps_from_dbus_parses_feature_access_status_and_reason_keys(), clamped_scroller(), cpu_caps_from_dbus_parses_structured_control_access_rows(), cpu_telemetry_from_dbus_supports_logical_cpu_id_and_core_id_alias(), cpu_unlock_label_is_limited_to_controls_that_need_authorization() (+19 more)
...
Cohesion: 0.19
Nodes (12): check_polkit_authorization(), PrivilegedService, Arc, Connection, Mutex, Option, Result, RogResult (+4 more)
...
Cohesion: 0.19
Nodes (15): RogError, map_privileged_cpu_error(), map_privileged_fan_error(), map_privileged_lighting_error(), fan_domain(), main(), map_battery_error(), map_cpu_error() (+7 more)

### Community 76 - ".sanitize"
Cohesion: 0.23
Nodes (11): fan_curve_sanitize_clamps(), fan_curve_sanitize_sorts_and_enforces_monotonic(), FanCurvePolicy, parse_hex_byte(), Default, RogResult, SafeFloor, validate_fan_curve_points() (+3 more)
...
### Community 86 - "telemetry_to_dbus"
Cohesion: 0.18
Nodes (10): battery_state_to_str(), consolidated_matrix_preserves_external_daemons_and_battery_fallback_boundary(), cpu_caps_to_dbus_emits_structured_control_access_rows(), cpu_to_dbus_includes_logical_cpu_id_and_core_id_alias(), power_source_to_str(), rows_from_value(), Vec, telemetry_to_dbus() (+2 more)

### Community 87 - "RogHelperDaemon"
Cohesion: 0.14
Nodes (8): map_rog_error_to_fdo(), parse_gpu_mode_request(), parse_profile_request(), RogHelperDaemon, Error, Into, Result, RogResult
...
### Community 89 - "String"
Cohesion: 0.11
Nodes (44): CpuCoreTelemetry, CpuTelemetry, FanState, TelemetrySnapshot, caps_from_dbus(), caps_text_from_dbus(), cpu_access_report_text(), cpu_caps_from_dbus() (+36 more)
...
### Community 96 - "String"
Cohesion: 0.17
Nodes (10): display_backend_name(), LightingDiagnostics, LightingState, list_text(), normalize_lighting_word(), opt_text(), opt_u32(), Option (+2 more)

### Community 97 - ".lighting_to_dbus"
Cohesion: 0.14
Nodes (12): apply_cpu_privilege_to_caps(), ControlState, cpu_access_warning(), CpuPrivilegeState, lighting_access_with_privilege(), lighting_helper_ready(), Default, Option (+4 more)

### Community 98 - "rog-daemon/src/main.rs"
Cohesion: 0.09
Nodes (42): apply_fan_caps_to_device_caps(), apply_fan_privilege_to_state(), apply_supergfx_probe_to_caps(), apply_supergfx_unavailable_to_caps(), authorization_denial_is_preserved_as_permission_error(), battery_helper_denial_and_unavailability_remain_distinct(), caps_to_dbus_emits_feature_access_status_and_reason_keys(), ControlPrivilegeRow (+34 more)

### Community 99 - ".detect"
Cohesion: 0.33
Nodes (4): detect_maintainer_name(), package_authors(), package_value(), Self

### Community 100 - "PrivilegedError"
Cohesion: 0.24
Nodes (19): B, PrivilegedError, apply_cpu(), battery_helper_unavailable(), call_fan(), fan_helper_unavailable(), helper_unavailable(), lighting_helper_unavailable() (+11 more)
...
- **Why does `KbdBacklightSysfs` connect `KbdBacklightSysfs` to `.lighting_to_dbus`, `rog-daemon/src/main.rs`, `rog-cli/src/main.rs`, `PrivilegedService`, `RogError`, `RogHelperDaemon`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `RogHelperDaemon` connect `RogHelperDaemon` to `String`, `.lighting_to_dbus`, `rog-daemon/src/main.rs`, `String`, `aura.rs`, `cpu.rs`, `AsusdPlatformProvider`, `hwmon.rs`, `KbdBacklightSysfs`, `supergfx.rs`, `power_supply.rs`, `config.rs`, `Self`, `telemetry_to_dbus`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `build_ui()` connect `build_ui` to `.detect`, `rog-ui/src/main.rs`, `spawn_background`, `MetricCard`, `.new`, `String`, `FanInfo`, `Option`?**
